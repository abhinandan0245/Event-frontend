        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            >
              ...
              <span className="text-white text-[10px] md:text-sm ml-1">
                EVENTS LLP
              </span>
            </Link>
          </motion.div>
          ...
          <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            {navLinks.map((link, index) => (
              ...
              >
                {link.special ? (
                  // Special Contact Link with Borders on All Sides
                  <NavLink
                    to={link.path}
                    className={({ isActive }) =>
                      `relative group px-4 py-2 rounded-lg font-semibold transition-all duration-300 inline-flex items-center ${
                        isActive
                  ...
                  >
                    {/* Border 1 - Top Border with Animation */}
                    <motion.span
                    ...
                    {/* Border 2 - Bottom Border with Animation */}
                    <motion.span
                    ...
                    {/* Border 3 - Left Border with Animation */}
                    <motion.span
                    ...
                    {/* Border 4 - Right Border with Animation */}
                    <motion.span
                    ...
                    {/* Corner Decorations */}
                    <span className="absolute top-0 left-0 w-2 h-2 border-t-2 border-l-2 border-gold-400/60" />
                    <span className="absolute top-0 right-0 w-2 h-2 border-t-2 border-r-2 border-gold-400/60" />
                    <span className="absolute bottom-0 left-0 w-2 h-2 border-b-2 border-l-2 border-gold-400/60" />
                    <span className="absolute bottom-0 right-0 w-2 h-2 border-b-2 border-r-2 border-gold-400/60" />
